...
(male)    
    ...
    # POST:
        step 1. Create New Request
                ...
                Set method to POST
                Enter URL: http://localhost:3000/api/measurements/male
    ...
    # PUT:
        step 1. Create New Request
                Click "+" → "HTTP Request"
                Set method to PUT
                Enter URL: http://localhost:3000/api/measurements/male/{female_id}
...
(female)    
    # GET:      http://localhost:3000/api/measurements/female
    # GET/ID:   http://localhost:3000/api/measurements/female/{id-number}
    # DELETE:   http://localhost:3000/api/measurements/female/{id-number}
