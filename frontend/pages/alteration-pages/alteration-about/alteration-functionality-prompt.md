...
"3. this is alteration-female-bottom.html: 
   <!--Alteration Section-->
   <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <div class="alteration-list">
                    <label for="alteration">Bottom (female):</label>
	...
	"
"4. this is alteration-female-dress.html: 
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <div class="alteration-list">
                    <!--Bodice-->
                    <label for="alteration">Bodice: (female)</label>
                    ...
                    <!--Sleeve-->
                    <label for="alteration">Sleeve:</label>
                    ...
                    <!--Skirt-->
                    <label for="alteration">Skirt:</label>
                    ...
                    <!--Bustle-->
                    <label for="alteration">Bustle:</label>
                    ...
                    <!--Veil-->
                    <label for="alteration">Veil:</label>
                    ...
                    <!--Others-->
                    <label for="alteration">Others:</label>
...
"5. this is alteration-female-jacket.html: 
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">Jacket (female):</label>
                    <select id="alteration-top-Select">
                        <option id="alteration-type-default" value="" data-link="" hidden></option>
                        ...
                        <option value="female-jacket-shorten-length" data-link="">shorten length</option>                    </select>
                </div>
	...
	"
"6. this is alteration-female-top.html: 
    <!--Alteration Section-->
     <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">Top (female):</label>
                    <select id="alteration-top-Select">
                        <option id="alteration-type-default" value="" data-link="" hidden></option>
    ...
    "
"7. this is alteration-male-bottom.html: 
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">Bottom (male):</label>
                    <select id="alteration-top-Select">
                        <option id="alteration-type-default" value="" data-link="" hidden></option>
	...
	"
"8. this is alteration-male-suits.html:  
    <!--Alteration Section-->
   <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">Vest: (male-suits)</label>
                    ...
                    <label for="alteration">Jacket:</label>
                    ...
                    <label for="alteration">Pants:</label>
	...
	"
"9. this is alteration-male-top.html: 
    <!--Alteration Section-->
     <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">Top (male):</label>
                    <select id="alteration-top-Select">
                        <option id="alteration-type-default" value="" data-link="" hidden></option>
	...
	"
"9. this is alteration-repair.html: 
    <!--Alteration Section-->
     <div class="container">
        <form id="myForm" action="/submit" method="POST">
            <div class="alteration-container">
                ...
                <h2 id="price-list">Price list</h2>      
                <div class="alteration-list">
                    <label for="alteration">repair (unisex):</label>
                    <select id="alteration-top-Select">
                        <!--Zippers-->
                        <option id="alteration-type-default" value="" data-link="" hidden></option>
    ...
    "
"10. this is the CSS. make adjustment if necessary but do not change the layout and structure : 
	...
	/* Keep existing button styles but adjust for new layout */
	button {
	    padding: 6px 12px;
...
"12. calculate the price and display when alteration and alterationLevel are both selected"
"13. only one alteration can be selected"
"14. when price is greater than 0, <p id="alteration-note"> will display: 
					• Prices are determined by the complexity and the specific requirements of the customer request. "
"15. add a condition when price is greater than 0 and level is simple: <p id="alteration-description"> will display {Alteration detail} key from alterationMaps"
"16. add a condition when price is greater than 0 and level is intermediate: 
					<p id="alteration-description"> will display: • {Alteration detail} from alterationMaps 
					<p id="alteration-customer-request"> will display: • plus one customer-requested modification "
										     
"17. add a condition when price is greater than 0 and level is difficult: 
					<p id="alteration-description"> will display • "{Alteration detail} from alterationMaps
					<p id="alteration-customer-request"> will display: • plus two customer-requested modification "																

"18. add a condition when price is greater than 0, <p id="alteration-type"> will display: Alteration type key from const alterationMaps"
"19. add a condition when price is greater than 0, <p id="alteration-level"> will display: Alteration level key: from const alterationMaps"
"20. add a condition that will display n.a if the price is $0 ."
"21. add a condition that if price is n.a then <p id="alteration-note"> will display blank"
"22. add a condition that if price is n.a then <p id="alteration-description"> will display blank"
"23. add a condition that if price is n.a then <p id="alteration-customer-request"> will display blank"
"24. add a condition that if price is n.a then <p id="alteration-type"> will display blank"
"25. add a condition that if price is n.a then <p id="alteration-level"> will display blank"
"26. handleAdd() will add to shopping cart. Just put alert for now and this is not needed yet"		
"27. handleClear() that will reset all drop down options, clear all summary and clear <span id="priceCalculation"> when click "  
"28. implement separation of concern but only use 3 modules: data-maps.js. main.js, alteration-manager.js"
"29. main.js is the only link to html files"
"30. make it simple"
"31. make it scalable"
"32. make it reusable for future update"
"33. do not change the html"
"34. add comments" 
"35. explain the flow of the program and how it works"