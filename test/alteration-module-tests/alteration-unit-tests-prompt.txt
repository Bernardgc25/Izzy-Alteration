1.I need to create unit tests for a JavaScript module. Here's my project structure:
...
2.Please create mocha unit tests for the following and place them in the tests/alteration-module-tests directory.
3. Provide instructions how to use
here are the files: 
