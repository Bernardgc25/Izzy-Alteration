"1. the following html files share the same CSS design (alteration.css)
code 1 - alteration-female-bottom.html: 
[
   <!--Alteration Section-->
   <div class="container">
...
code 2 - alteration-female-dress.html: 
[
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
code 3 - alteration-female-jacket.html: 
[
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
code 4 - alteration-female-top.html:
[ 
    <!--Alteration Section-->
     <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
code 5 - alteration-male-bottom.html: 
[
    <!--Alteration Section-->
    <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
code 6- alteration-male-suits.html:  
[
    <!--Alteration Section-->
   <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
code 7 - alteration-male-top.html: 
[
    <!--Alteration Section-->
     <div class="container">
        <form id="myForm" action="/submit" method="POST">
...
[
    ...
    768px (appears again in portrait orientation query)

    992px (appears again in landscape orientation query)


]
"

"3. create a responsive that is based on the sample.css and implement on code 9 - alteration.css" 
"4. do not change the original structure, layout and behavior"
